...
import (
	"fmt"
	"golangstarter/auth"
	"golangstarter/campaign"
	"golangstarter/handler"
	"golangstarter/helper"
	"golangstarter/payment"
	"golangstarter/transaction"
	"golangstarter/user"
	"log"
	"net/http"
	"path/filepath"
	...
	webHandler "golangstarter/web/handler"
...
func main() {
	dsn := "root:Password@tcp(127.0.0.1:3306)/go_gin_app_db?charset=utf8mb4&parseTime=True&loc=Local"
